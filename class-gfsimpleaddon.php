...
class GFSimpleAddOn extends GFAddOn {
	...
	public function form_settings_fields( $form ) {	
		...
		$fields = array(
			array(
				"title"  => "Enable/Disable Side summary",
				
				"fields" => array(	
					array(
						'name'         => 'show_summary',
						'type'         => 'toggle',								
						'toggle_label' => esc_html__( 'Turn on summary', 'simpleaddon' ),
						'label'		   => esc_html__( 'Turn on summary', 'simpleaddon' ),
						"default_value" => false,
					),
					array(
		...
		$tabs = array(
			'general_tab' => array(
				'type' => 'tab',
				'id' => 'general_tab',
				'title' => esc_html__( 'General', 'simpleaddon' ),
				'sections' => $fields
			),
			
		);

		return $tabbed ? $tabs : $fields;			   
